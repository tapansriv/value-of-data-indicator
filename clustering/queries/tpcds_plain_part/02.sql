WITH wscs AS (
    ...
    FROM wscs, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS date_dim
    WHERE
...
FROM (
    ...
    FROM wswscs, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS date_dim
    WHERE
