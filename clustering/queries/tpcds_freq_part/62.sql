...
) AS sq1, READ_PARQUET('/home/cc/tpcds_cluster_base/ship_mode/*.parquet') AS ship_mode, READ_PARQUET('/home/cc/tpcds_cluster_base/web_site/*.parquet') AS web_site, READ_PARQUET('/home/cc/tpcds_cluster_freq/date_dim/*.parquet') AS date_dim
WHERE
