WITH all_sales AS (
    ...
    FROM (
        ...
        JOIN READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS date_dim
          ON d_date_sk = cs_sold_date_sk
        LEFT JOIN READ_PARQUET('/home/cc/tpcds_cluster_base/catalog_returns/*.parquet') AS catalog_returns
          ON (
        ...
        LEFT JOIN READ_PARQUET('/home/cc/tpcds_cluster_base/store_returns/*.parquet') AS store_returns
          ON (
        ...
        LEFT JOIN READ_PARQUET('/home/cc/tpcds_cluster_base/web_returns/*.parquet') AS web_returns
          ON (
