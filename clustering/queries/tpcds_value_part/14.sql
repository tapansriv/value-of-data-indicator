WITH cross_items AS (
    ...
    FROM READ_PARQUET('/home/cc/tpcds_cluster_value/item/*.parquet') AS item, (
        ...
        FROM READ_PARQUET('/home/cc/tpcds_cluster_base/store_sales/*.parquet') AS store_sales, READ_PARQUET('/home/cc/tpcds_cluster_value/item/*.parquet') AS iss, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS d1
        WHERE
        ...
        SELECT
          ...
          ics.i_class_id,
          ics.i_category_id
        FROM READ_PARQUET('/home/cc/tpcds_cluster_base/catalog_sales/*.parquet') AS catalog_sales, READ_PARQUET('/home/cc/tpcds_cluster_value/item/*.parquet') AS ics, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS d2
        WHERE
        ...
        SELECT
          ...
          iws.i_class_id,
          iws.i_category_id
        FROM READ_PARQUET('/home/cc/tpcds_cluster_value/web_sales/*.parquet') AS web_sales, READ_PARQUET('/home/cc/tpcds_cluster_value/item/*.parquet') AS iws, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS d3
        WHERE
    ...
    FROM (
        ...
        FROM READ_PARQUET('/home/cc/tpcds_cluster_value/web_sales/*.parquet') AS web_sales, READ_PARQUET('/home/cc/tpcds_cluster_base/date_dim/*.parquet') AS date_dim
        WHERE
