...
COPY (
    SELECT
        ...
        g.listener_register_time   AS listener_rg_time,
        v.vanilla_time_sec
    ...
    JOIN read_csv_auto('listener_register_results_r1to9.csv') r
      USING (query, dataset, run_number)
    JOIN read_csv_auto('listener_rg_results_r1to9.csv') g
      USING (query, dataset, run_number)
    ...
    ORDER BY 
        ...
        b.run_number,
        b.query
) to 'final_results_custom_spark_8_26.csv' (FORMAT CSV, HEADER TRUE)
'''
