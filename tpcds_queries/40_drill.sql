...
LEFT OUTER JOIN dfs.`tmp/catalog_returns.parquet` AS catalog_returns ON (cs_order_number = cr_order_number
                                    AND cs_item_sk = cr_item_sk) ,dfs.`tmp/warehouse.parquet` AS warehouse,
