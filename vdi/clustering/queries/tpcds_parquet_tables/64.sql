...
cross_sales AS
  (SELECT i_product_name product_name,
   ...
   FROM 'store_sales.parquet' AS store_sales,
        ...
        'household_demographics.parquet' hd1,
        'household_demographics.parquet' hd2,
        'customer_address.parquet' ad1,
        'customer_address.parquet' ad2,
        'income_band.parquet' ib1,
        'income_band.parquet' ib2,
