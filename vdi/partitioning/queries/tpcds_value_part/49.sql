...
FROM (
    ...
    FROM (
        ...
        FROM (
            ...
            FROM READ_PARQUET('/home/cc/tpcds_partitioned_value/web_sales/**/*.parquet', hive_partitioning = 1) AS ws
            LEFT OUTER JOIN READ_PARQUET('web_returns.parquet') AS wr
              ...
              ), READ_PARQUET('date_dim.parquet') AS date_dim
            WHERE
    ...
    FROM (
        ...
        FROM (
            ...
            FROM READ_PARQUET('store_sales.parquet') AS sts
