WITH year_total AS (
    SELECT
      ...
      's' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('store_sales.parquet') AS store_sales, READ_PARQUET('date_dim.parquet') AS date_dim
    WHERE
    ...
    SELECT
      ...
      'c' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('date_dim.parquet') AS date_dim
    WHERE
    ...
    SELECT
      ...
      'w' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('/home/cc/tpcds_partitioned_value/web_sales/**/*.parquet', hive_partitioning = 1) AS web_sales, READ_PARQUET('date_dim.parquet') AS date_dim
    WHERE
