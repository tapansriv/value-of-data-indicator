...
FROM (
    ...
    FROM (
        ...
        FROM (
            ...
            FROM READ_PARQUET('store_sales.parquet') AS ss1
            WHERE
              ss_store_sk = 4
            GROUP BY
              ss_item_sk
    ...
    WHERE
      rnk < 11
) AS descending, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS i1, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS i2
WHERE
