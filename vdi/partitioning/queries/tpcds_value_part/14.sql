WITH cross_items AS (
    ...
    FROM READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS item, (
        ...
        FROM READ_PARQUET('store_sales.parquet') AS store_sales, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS iss, READ_PARQUET('date_dim.parquet') AS d1
        WHERE
        ...
        SELECT
          ...
          ics.i_class_id,
          ics.i_category_id
        FROM READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS ics, READ_PARQUET('date_dim.parquet') AS d2
        WHERE
        ...
        SELECT
          ...
          iws.i_class_id,
          iws.i_category_id
        FROM READ_PARQUET('/home/cc/tpcds_partitioned_value/web_sales/**/*.parquet', hive_partitioning = 1) AS web_sales, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS iws, READ_PARQUET('date_dim.parquet') AS d3
        WHERE
    ...
    FROM (
        ...
        FROM READ_PARQUET('store_sales.parquet') AS store_sales, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS item, READ_PARQUET('date_dim.parquet') AS date_dim
        WHERE
          ss_item_sk IN (
              SELECT
                ss_item_sk
