WITH v1 AS (
    ...
    FROM READ_PARQUET('item.parquet') AS item, READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim, READ_PARQUET('call_center.parquet') AS call_center
    WHERE
