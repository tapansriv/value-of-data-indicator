...
FROM (
    ...
    FROM READ_PARQUET('web_sales.parquet') AS web_sales, READ_PARQUET('warehouse.parquet') AS warehouse, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim, READ_PARQUET('time_dim.parquet') AS time_dim, READ_PARQUET('ship_mode.parquet') AS ship_mode
    WHERE
    ...
    FROM READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('warehouse.parquet') AS warehouse, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim, READ_PARQUET('time_dim.parquet') AS time_dim, READ_PARQUET('ship_mode.parquet') AS ship_mode
    WHERE
