WITH results AS (
    ...
    FROM READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('customer_demographics.parquet') AS cd1, READ_PARQUET('customer_demographics.parquet') AS cd2, READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('customer_address.parquet') AS customer_address, READ_PARQUET('date_dim.parquet') AS date_dim, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS item
    WHERE
