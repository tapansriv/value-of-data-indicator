WITH inv AS (
    ...
    FROM (
        ...
        FROM READ_PARQUET('inventory.parquet') AS inventory, READ_PARQUET('/home/cc/tpcds_partitioned_value/item/**/*.parquet', hive_partitioning = 1) AS item, READ_PARQUET('warehouse.parquet') AS warehouse, READ_PARQUET('date_dim.parquet') AS date_dim
        WHERE
