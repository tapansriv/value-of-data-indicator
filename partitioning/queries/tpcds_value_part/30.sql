WITH customer_total_return AS (
    ...
    FROM READ_PARQUET('web_returns.parquet') AS web_returns, READ_PARQUET('date_dim.parquet') AS date_dim, READ_PARQUET('customer_address.parquet') AS customer_address
    WHERE
