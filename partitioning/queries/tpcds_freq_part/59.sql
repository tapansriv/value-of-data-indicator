...
FROM (
    ...
    FROM wss, READ_PARQUET('store.parquet') AS store, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS d
    WHERE
