WITH cross_items AS (
    ...
    FROM READ_PARQUET('item.parquet') AS item, (
        ...
        FROM READ_PARQUET('/home/cc/tpcds_partitioned_freq/store_sales/**/*.parquet', hive_partitioning = 1) AS store_sales, READ_PARQUET('item.parquet') AS iss, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS d1
        WHERE
        ...
        SELECT
          ...
          ics.i_class_id,
          ics.i_category_id
        FROM READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('item.parquet') AS ics, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS d2
        WHERE
        ...
        SELECT
          ...
          iws.i_class_id,
          iws.i_category_id
        FROM READ_PARQUET('web_sales.parquet') AS web_sales, READ_PARQUET('item.parquet') AS iws, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS d3
        WHERE
