WITH year_total AS (
    SELECT
      ...
      's' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('/home/cc/tpcds_partitioned_freq/store_sales/**/*.parquet', hive_partitioning = 1) AS store_sales, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim
    WHERE
    ...
    SELECT
      ...
      'c' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('catalog_sales.parquet') AS catalog_sales, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim
    WHERE
    ...
    SELECT
      ...
      'w' AS sale_type
    FROM READ_PARQUET('customer.parquet') AS customer, READ_PARQUET('web_sales.parquet') AS web_sales, READ_PARQUET('/home/cc/tpcds_partitioned_freq/date_dim/**/*.parquet', hive_partitioning = 1) AS date_dim
    WHERE
